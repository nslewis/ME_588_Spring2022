...
void displaySensorVals(uint16_t sensorValues[]) {
...
//    delay(50);
//    displaySensorVals(sensorValues);
//    forward_start();
//  }
...
int move_forward() {
  ...
  //  //int pos_distance[3] = {1000,1000,1000};
...
void loop() {
  ...
  switch (STATE) {
    ...
    case FORWARD_STATE:
      ...
      STATE = move_forward(); // Make Function for this
      break;
    case DROP_STATE:
